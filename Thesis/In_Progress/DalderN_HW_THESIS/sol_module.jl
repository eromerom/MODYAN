...
function write_sol_in_multiple_cuboids(iX, iY, iZ, fX, fY, fZ, Nz)
	...
	= "", xlabel = "z (nm)", ylabel = "Average Number of Molecules", legend = false, ylim = (0, 710), xlim = (0, 9.5), color = :red)
...
function write_dipole_moment_sol()
	qow = -0.7752308291*0.8424 # Replace with your desired charge
	qhw = 0.7752308291*0.4212  # Replace with your desired charge
