...
function counting_unk()
	...
	open("count_unk.log", "w") do io
		...
		for time in sort(collect(keys(results)))
			...
			in molecule_names if molecule_name[end-2:end] == "UNK"]
   ...
   open("write_unk.log", "w") do io
      for time in sort(collect(keys(results)))
         molecule_names, atom_names, atom_coords, _ = results[time]
			unk_indices = [i for i in 1:length(molecule_names) if molecule_names[i][end-2:end] == "UNK"]
			write(io, "Time: $time\n")
...
function write_unk_in_multiple_cuboids(iX, iY, iZ, fX, fY, fZ, Nz)
	...
	= "", xlabel = "z (nm)", ylabel = "Average Number of Molecules", legend = false, ylim=(0, 160))
	savefig(p_avg, "UNK_cuboid_average.pdf")
end


function dipole_moment_unk(results, qh00, qc01, qc02, qc03, qn04, qh05, qh06, qc07, qh08, qc09, qc0a,
qh0b, qc0c, qh0d, qc0e, qh0f, qc0g, qh0h, qh0i, qh0j, qh0k)
	...
	for time in sort(collect(keys(results)))
		...
		for unk_molecule in unk_molecules
			...
			for i in indices
				...
				charge = 0.0
				if atom_name[1:3] == "H00"
					charge = qh00
				elseif atom_name[1:3] == "C01"
					charge = qc01
				elseif atom_name[1:3] == "C02"
					charge = qc02
				elseif atom_name[1:3] == "C03"
					charge = qc03
				elseif atom_name[1:3] == "N04"
					charge = qo04
				elseif atom_name[1:3] == "H05"
					charge = qh05
				elseif atom_name[1:3] == "H06"
					charge = qh06
				elseif atom_name[1:3] == "C07"
					charge = qc07
				elseif atom_name[1:3] == "H08"
					charge = qc08
				elseif atom_name[1:3] == "C09"
					charge = qc09
				elseif atom_name[1:3] == "C0A"
					charge = qh0a
				elseif atom_name[1:3] == "H0B"
					charge = qc0b
				elseif atom_name[1:3] == "C0C"
					charge = qh0c
				elseif atom_name[1:3] == "H0D"
					charge = qc0d
				elseif atom_name[1:3] == "C0E"
					charge = qh0e
				elseif atom_name[1:3] == "H0F"
					charge = qc0f
				elseif atom_name[1:3] == "C0G"
					charge = qh0g
...
function write_dipole_moment_unk()
	qh00 = 0.9216292875*0.1360 # Replace with your desired charge
	qc01 = -0.9216292875*0.2273 # Replace with your desired charge
	qc02 = 0.9216292875*0.1473 # Replace with your desired charge
	qc03 = -0.9216292875*0.2259 # Replace with your desired charge
	qn04 = -0.9216292875*0.8995 # Replace with your desired charge
	qh05 = 0.9216292875*0.1067 # Replace with your desired charge
	qh06 = 0.9216292875*0.1067 # Replace with your desired charge
	qc07 = 0.9216292875*0.2676 # Replace with your desired charge
	qh08 = 0.9216292875*0.4502 # Replace with your desired charge
	qc09 = -0.9216292875*0.2279 # Replace with your desired charge
	qc0a = -0.9216292875*0.2158 # Replace with your desired charge
	qh0b = 0.9216292875*0.1415 # Replace with your desired charge
	qc0c = -0.9216292875*0.0972 # Replace with your desired charge
	qh0d = 0.9216292875*0.1490 # Replace with your desired charge
	qc0e = -0.9216292875*0.0995 # Replace with your desired charge
	qh0f = 0.9216292875*0.1426 # Replace with your desired charge
	qc0g = -0.9216292875*0.2015 # Replace with your desired charge
	qh0h = 0.9216292875*0.1417 # Replace with your desired charge
	qh0i = 0.9216292875*0.1475 # Replace with your desired charge
	qh0j = 0.9216292875*0.1289 # Replace with your desired charge
	qh0k = 0.9216292875*0.1289 # Replace with your desired charge

	results = process_gromacs_files()
	dipole_moment_unk_dict = dipole_moment_unk(results, qh00, qc01, qc02, qc03, qo04, qh05, qh06, qc07, qc08, qc09, qh0a,
qc0b, qh0c, qc0d, qh0e, qc0f, qh0g, qh0h, qh0i, qh0j, qh0k)
...
function process_sph_dipoles_unk()
   ...
   qh0k = 0.9216292875*0.1289 # Replace with your desired charge
	...
	results = process_gromacs_files()
	dipole_moment_unk_dict = dipole_moment_unk(results, qh00, 
	qc01, qc02, qc03, qo04, qh05, qh06, qc07, qc08, qc09, qh0a,
	qc0b, qh0c, qc0d, qh0e, qc0f, qh0g, qh0h, qh0i, qh0j, qh0k)
...
function count_unk_in_cuboid_theta_dict(centre_of_mass_unk_dict, sph_dipoles_dict, iX, iY, iZ, fX, fY, fZ)
   ...
   qh0k = 0.9216292875*0.1289 # Replace with your desired charge
    ...
    for (time, unk_data) in centre_of_mass_unk_dict
		  ...
		  qh00, qc01, qc02, qc03, qo04, qh05, qh06, qc07, qc08,
		  qc09, qh0a, qc0b, qh0c, qc0d, qh0e, qc0f, qh0g, qh0h, qh0i, qh0j, qh0k)
        sph_dipoles_unk = store_sph_dipoles_unk(dipole_moment_unk_dict)
