...
function get_atomic_charges()
	return Dict(
		...
		"C00" => -0.9618222787*0.2882,
		"C01" => -0.9618222787*0.1654,
		"C02" => 0.9618222787*0.3031,
		"O03" => -0.9618222787*0.3752,
		"H04" => 0.9618222787*0.0922,
		"H05" => 0.9618222787*0.1654,
		"H06" => 0.9618222787*0.1341,
		"H07" => 0.9618222787*0.1341,
		"C0A" => -0.8286951127*0.1548,
		"C0B" => -0.8286951127*0.1552,
		"C0C" => -0.8286951127*0.2352,
		"C0D" => -0.8286951127*0.2352,
		"H0E" => 0.8286951127*0.1346,
		"H0F" => 0.8286951127*0.1277,
		"H0G" => 0.8286951127*0.1277,
		"H0H" => 0.8286951127*0.1345,
		"H0I" => 0.8286951127*0.1279,
		"H0J" => 0.8286951127*0.1279,
							)
end
