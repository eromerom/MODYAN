...
function show_help_unk()
	println("""
	┌─────────────────────────────────────────────────────────────────────────────────────┐
	│                             List of Available Functions                             │
	├─────────────────────────────────────────────────────────────────────────────────────┤
	│ 1: Count and update UNK molecule dictionaries.                                      │
	│ 2: Log UNK molecule coordinates.                                                    │
	│ 3: Log the center of mass for each UNK molecule.                                    │
	│ 4: Count and log the number of UNK molecules in a single cuboid.                    │
	│ 5: Count and log the number of UNK molecules in multiple cuboids.                   │
	│ 6: Calculate and log UNK molecule dipole moments in Cartesian coordinates.          │
	│ 7: Update and calculate the dipole moment library for UNK molecules in spherical    │
	│    coordinates.                                                                     │
	│ 8: Count and log the theta values for UNK molecules in multiple cuboids.            │
	│ 9: Generate RDF plots (UNK-UNK, single molecule).                                   │
	│ 10: Generate RDF plots (UNk-UNK, all molecules).                                    │
	...
	while true
		...
		elseif input == "help"
			...
			if function_number == 1
				println("counting_unk() has been selected, no argument required.")
			...
			elseif function_number == 2
				println("write_unk() has been selected, no argument required.")
			...
			elseif function_number == 3
				println("write_com_unk() has been selected, no arguments required.")
			...
			elseif function_number == 4
				println("write_unk_in_cuboid(iX, iY, iZ, fX, fY, fZ) has been selected.\n")
				...
				stop_channel = Channel(1)
				progress_task = @async show_progress(stop_channel)
				write_unk_in_cuboid(iX, iY, iZ, fX, fY, fZ)
				put!(stop_channel, true)
				@async progress_task

			elseif function_number == 5
				println("write_unk_in_multiple_cuboids(iX, iY, iZ, fX, fY, fZ, Nz) has been selected.\n")
				println("Arguments are required.\n")
            ...
            args = split(args_input)
				...
				stop_channel = Channel(1)
				progress_task = @async show_progress(stop_channel)
				write_unk_in_multiple_cuboids(iX, iY, iZ, fX, fY, fZ, Nz)
				put!(stop_channel, true)
				@async progress_task

			elseif function_number == 6
				println("write_dipole_moment_unk() has been selected, no arguments are needed.")
				...
				stop_channel = Channel(1)
				progress_task = @async show_progress(stop_channel)
				write_dipole_moment_unk()
				put!(stop_channel, true)
				@async progress_task

			elseif function_number == 7
				println("process_sph_dipoles_unk() has been selected, no arguments are needed.")
				println("Please be aware that the atom charges have already been established in")
				println("the code based on the MD parameters. If any adjustments are required,")
				println("please make them accordingly.")
				...
				stop_channel = Channel(1)
				progress_task = @async show_progress(stop_channel)
				process_sph_dipoles_unk()
				put!(stop_channel, true)
				@async progress_task

			elseif function_number == 8
				println("write_unk_theta_in_multiple_cuboids(iX, iY, iZ, fX, fY, fZ, Nz) has been selected.\n")
				println("Arguments are required.\n")
				println("Please be aware that the atom charges have already been established in")
				println("the code based on the MD parameters. If any adjustments are required,")
				println("please make them accordingly.")
				...
				stop_channel = Channel(1)
				progress_task = @async show_progress(stop_channel)
				write_unk_theta_in_multiple_cuboids(iX, iY, iZ, fX, fY, fZ, Nz)
				put!(stop_channel, true)
				@async progress_task
						
			elseif function_number == 9
				println("rdf_unk(unk_molecule_name, dr, max_distance, iX, iY, iZ, fX, fY, fZ) has been selected.\n")
				println("Arguments are required.\n")
				println("Please enter them as unk_molecule_name   dr   max_distance.\n")
				println("As a reference, the dimensions of the NVT simulation box are")
				print("0.0   0.0   0.0")
				...
				stop_channel = Channel(1)
				progress_task = @async show_progress(stop_channel)
				rdf_unk(unk_molecule_name, dr, max_distance, iX, iY, iZ, fX, fY, fZ)
				put!(stop_channel, true)
				@async progress_task

			elseif function_number == 10
				println("rdf_unk_all(dr, max_distance, iX, iY, iZ, fX, fY, fZ) has been selected.\n")
				println("Arguments are required.\n")
				...
				stop_channel = Channel(1)
				progress_task = @async show_progress(stop_channel)
				rdf_unk_all(dr, max_distance, iX, iY, iZ, fX, fY, fZ)
				put!(stop_channel, true)
				@async progress_task
