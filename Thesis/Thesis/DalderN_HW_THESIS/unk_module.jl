...
function dipole_moment_unk(results, qc00, qc01, qc02, qh03, qn04, qh05, qh06, qh07, qh08, qc0a, qc0b,
qc0c, qc0d, qh0e, qh0f, qh0g, qh0h, qh0i, qh0j)
...
function write_dipole_moment_unk()
	qc00 = -0.8879014056*0.1983 # Replace with your desired charge
	qc01 = -0.8879014056*0.1724 # Replace with your desired charge
	qc02 = 0.8879014056*0.1328 # Replace with your desired charge
	qh03 = 0.8879014056*0.1064 # Replace with your desired charge
	qn04 = -0.8879014056*0.6161 # Replace with your desired charge
	qh05 = 0.8879014056*0.1414 # Replace with your desired charge
	qh06 = 0.8879014056*0.1393 # Replace with your desired charge
	qh07 = 0.8879014056*0.1393 # Replace with your desired charge
	qh08 = 0.8879014056*0.3276 # Replace with your desired charge
	qc0a = -1.08683116*0.1576 # Replace with your desired charge
	qc0b = -1.08683116*0.1561 # Replace with your desired charge
	qc0c = -1.08683116*0.2363 # Replace with your desired charge
	qc0d = -1.08683116*0.2356 # Replace with your desired charge
	qh0e = 1.08683116*0.1356 # Replace with your desired charge
	qh0f = 1.08683116*0.1282 # Replace with your desired charge
	qh0g = 1.08683116*0.1282 # Replace with your desired charge
	qh0h = 1.08683116*0.1370 # Replace with your desired charge
	qh0i = 1.08683116*0.1283 # Replace with your desired charge
	qh0j = 1.08683116*0.1283 # Replace with your desired charge

	results = process_gromacs_files()
	dipole_moment_unk_dict = dipole_moment_unk(results, qc00, qc01, qc02, qh03, 
	qn04, qh05, qh06, qh07, qh08, qc0a, qc0b,
	qc0c, qc0d, qh0e, qh0f, qh0g, qh0h, qh0i, qh0j)
...
function process_sph_dipoles_unk()
   ...
   qh0j = 1.08683116*0.1283 # Replace with your desired charge
	...
	results = process_gromacs_files()
	dipole_moment_unk_dict = dipole_moment_unk(results, qc00, qc01, 
	qc02, qh03, qn04, qh05, qh06, qh07, qh08, qc0a, qc0b, 
	qc0c, qc0d, qh0e, qh0f, qh0g, qh0h, qh0i, qh0j)
...
function count_unk_in_cuboid_theta_dict(centre_of_mass_unk_dict, sph_dipoles_dict, iX, iY, iZ, fX, fY, fZ)
   ...
   qh0j = 1.08683116*0.1283 # Replace with your desired charge
    ...
    for (time, unk_data) in centre_of_mass_unk_dict
		  ...
		  qc00, qc01, qc02, qh03, qn04, qh05, qh06, qh07, qh08, qc0a, qc0b,
		  qc0c, qc0d, qh0e, qh0f, qh0g, qh0h, qh0i, qh0j)
        sph_dipoles_unk = store_sph_dipoles_unk(dipole_moment_unk_dict)
...
function write_unk_theta_in_multiple_cuboids(iX, iY, iZ, fX, fY, fZ, Nz)
   ...
   qh0j = 1.08683116*0.1283 # Replace with your desired charge
    ...
    results = process_gromacs_files()
    centre_of_mass_unk_dict = centre_of_mass_unk(results)
	 dipole_moment_unk_dict = dipole_moment_unk(results, qc00, qc01, qc02, 
	 qh03, qn04, qh05, qh06, qh07, qh08, qc0a, qc0b,
	 qc0c, qc0d, qh0e, qh0f, qh0g, qh0h, qh0i, qh0j)
