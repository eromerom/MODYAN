...
function dipole_moment_unk(results, qh00, qc01, qc02, qc03, qo04, qh05, qh06, qc07, qc08, qc09, qh0a,
qc0b, qh0c, qc0d, qh0e, qc0f, qh0g, qh0h, qh0i, qh0j)
		...
		for unk_molecule in unk_molecules
			...
			for i in indices
				...
				elseif atom_name[1:3] == "C07"
					charge = qc07
				elseif atom_name[1:3] == "C08"
					charge = qc08
				elseif atom_name[1:3] == "C09"
					charge = qc09
				elseif atom_name[1:3] == "H0A"
					charge = qh0a
				elseif atom_name[1:3] == "C0B"
					charge = qc0b
				elseif atom_name[1:3] == "H0C"
					charge = qh0c
				elseif atom_name[1:3] == "C0D"
					charge = qc0d
				elseif atom_name[1:3] == "H0E"
					charge = qh0e
				elseif atom_name[1:3] == "C0F"
					charge = qc0f
...
function write_dipole_moment_unk()
	qh00 = 0.6479794138*0.1521 # Replace with your desired charge
	qc01 = -0.6479794138*0.2291 # Replace with your desired charge
	qc02 = 0.6479794138*0.0508 # Replace with your desired charge
	qc03 = -0.6479794138*0.2297 # Replace with your desired charge
	qo04 = -0.6479794138*0.3096 # Replace with your desired charge
	qh05 = 0.6479794138*0.1123 # Replace with your desired charge
	qh06 = 0.6479794138*0.1123 # Replace with your desired charge
	qc07 = 0.6479794138*0.1416 # Replace with your desired charge
	qc08 = -0.6479794138*0.1854 # Replace with your desired charge
	qc09 = -0.6479794138*0.2365 # Replace with your desired charge
	qh0a = 0.6479794138*0.1628 # Replace with your desired charge
	qc0b = -0.6479794138*0.1072 # Replace with your desired charge
	qh0c = 0.6479794138*0.1553 # Replace with your desired charge
	qc0d = -0.6479794138*0.1053 # Replace with your desired charge
	qh0e = 0.6479794138*0.1487 # Replace with your desired charge
	qc0f = -0.6479794138*0.1887 # Replace with your desired charge
	qh0g = 0.6479794138*0.1452 # Replace with your desired charge
	qh0h = 0.6479794138*0.1500 # Replace with your desired charge
	qh0i = 0.6479794138*0.1302 # Replace with your desired charge
	qh0j = 0.6479794138*0.1302 # Replace with your desired charge
...
function count_unk_in_cuboid_theta_dict(centre_of_mass_unk_dict, sph_dipoles_dict, iX, iY, iZ, fX, fY, fZ)
    ...
    for (time, unk_data) in centre_of_mass_unk_dict
		  ...
		  qc09, qh0a, qc0b, qh0c, qc0d, qh0e, qc0f, qh0g, qh0h, qh0i, qh0j)
        sph_dipoles_unk = store_sph_dipoles_unk(dipole_moment_unk_dict)
